...
var myE9Copendent = CopedentFactory.CreateE9();

// Display the Copendent
foreach (var theString in myE9Copendent.Strings)
{
    var theNote = theString.OpenNote;
    Console.WriteLine($"{theString.Number} :: {theNote}");
}
